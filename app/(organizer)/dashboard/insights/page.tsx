...
import LiveEventAnalytics from "@/components/insights/LiveEventAnalytics"
  ...
  return (
    <>
      ...
      <div style={{ maxWidth: 1040, margin: "0 auto", paddingBottom: "3rem" }}>
        ...
        {/* TOP TABS NAVIGATION (HAND-DRAWN WIREFRAME MATCH) */}
        <div
          style={{
            display: "flex",
            alignItems: "center",
            ...
            borderBottom: insightBorderSoft,
        ...
        >
          <button
            ...
            style={{
              background: activeTab === "tracker" ? "color-mix(in srgb, var(--accent) 15%, var(--surface))" : "transparent",
              border: activeTab === "tracker" ? insightAccentBorder : "1px solid transparent",
              borderRadius: 10,
              padding: "0.55rem 1.15rem",
              color: activeTab === "tracker" ? insightTextPrimary : insightTextSecondary,
              fontSize: "0.86rem",
              fontWeight: 600,
              fontFamily: "var(--font-dm-sans)",
              cursor: "pointer",
          ...
          >
            ...
            <span>Insight Tracker</span>
          </button>

          <button
            onClick={() => setActiveTab("live")}
            style={{
              background: activeTab === "live" ? "color-mix(in srgb, var(--accent) 15%, var(--surface))" : "transparent",
              border: activeTab === "live" ? insightAccentBorder : "1px solid transparent",
              borderRadius: 10,
              padding: "0.55rem 1.15rem",
              color: activeTab === "live" ? insightTextPrimary : insightTextSecondary,
              fontSize: "0.86rem",
              fontWeight: 600,
              fontFamily: "var(--font-dm-sans)",
              cursor: "pointer",
        ...
        {/* TAB 1: LIVE EVENT ANALYTICS */}
        {activeTab === "live" ? (
          <LiveEventAnalytics />
        ) : (
          /* TAB 2: INSIGHT TRACKER (CLASSIC) */
          <>
            {loading && (
              <div>
