        ...
        <div className="marketing-panel overflow-hidden px-5 py-10 sm:px-8 lg:px-12 lg:py-14">
          <div className="grid gap-8 lg:grid-cols-[minmax(0,1fr)_320px] lg:items-end">
            ...
            <div className="marketing-card">
              ...
              <h2 className="mt-6 text-[1.2rem] font-semibold text-white">Automatic by design</h2>
        ...
        <div className="marketing-shell">
          ...
          <div className="mt-8 grid gap-4 lg:grid-cols-2">
            <article className="marketing-card">
              <h3 className="text-[1.08rem] font-semibold text-white">Without a real waitlist</h3>
              <p className="mt-3 text-[0.96rem] leading-7 text-[rgba(240,237,230,0.66)]">
                Sold-out pages close the door too early, organisers do manual follow-up, and interested attendees disappear.
              </p>
            </article>
            <article className="marketing-card">
              <h3 className="text-[1.08rem] font-semibold text-white">With EventSlot</h3>
              <p className="mt-3 text-[0.96rem] leading-7 text-[rgba(240,237,230,0.66)]">
