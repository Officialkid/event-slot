...
| GROQ_API_KEY | Yes for customer assistant + event Q&A | AI provider | Groq console |
| OPENAI_API_KEY | Yes for voice transcription (Whisper) | voice assistant | OpenAI platform |
