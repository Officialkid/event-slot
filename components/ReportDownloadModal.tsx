      ...
      >
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "0.75rem" }}>
          <div>
            ...
            <h2 style={{ fontFamily: "var(--font-instrument-serif)", fontSize: "1.4rem", color: "var(--text-primary)", margin: 0 }}>
        ...
        <p style={{ fontSize: "0.85rem", color: "var(--text-secondary)", marginBottom: "1rem", lineHeight: "1.65" }}>
          Downloading the full Word report uses <strong style={{ color: "var(--text-primary)" }}>1 paid download slot</strong>.
        ...
        {typeof currentBalance === "number" && (
          ...
          >
            <p style={{ margin: 0, fontSize: "0.82rem", color: "var(--text-secondary)" }}>
              Current balance: <strong style={{ color: "var(--text-primary)" }}>{currentBalance}</strong> report download{currentBalance === 1 ? "" : "s"}
            </p>
          </div>
        )}
